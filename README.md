...
- Assumes gravity vector `[0, 0, -9.81]` m/s² in the `world` frame (pointing downward along the negative Z-axis)
...
- `net_ft_driver` and `dental_bringup` (optional, launch-only; required to run `ft_calibration.launch.py`)
